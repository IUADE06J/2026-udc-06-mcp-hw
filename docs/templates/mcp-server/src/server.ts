...
//
// TODO: register a resource, e.g. `inventory://catalog`, returning a summary
// (product count, categories, total inventory value). Shape of the handler's
// return value is a `contents` array of `{ uri, text }`. Check your SDK's
// docs for the exact registerResource signature.
